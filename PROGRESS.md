...
## ✨ รอบล่าสุด — คอมการ์ด: โลโก้ในกล่องข้อมูล + กติกาอายุใหม่ (2026-08-05, พี่คอนเฟิร์ม "Perfect")
...
## บันทึก "ส่ง proposal ให้ลูกค้าแล้ว" (2026-08-06) — โค้ดเสร็จ **ยังไม่ได้รัน migration**
...
- **migration `020_client_sent.sql`** — เพิ่มที่ `projects`: `client_sent_at` (timestamptz, null = ยังไม่ส่ง) · `client_sent_via` (line/email/link/other) · `client_sent_note` — **พี่ต้องรันเองใน Supabase SQL Editor** (ยังไม่ได้รัน)
