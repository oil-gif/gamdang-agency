...
// ข้อความตั้งใจไม่ฟันธงว่า 'วันเกิดผิด' — อาจเป็นส่วนสูงที่กรอกผิดก็ได้
//
...
export function suspiciousDob(
  ...
  if (age < 1 && cm > 80) return "อายุกับส่วนสูงไม่สมกัน (ไม่ถึง 1 ขวบ แต่สูงเกิน 80 ซม.)";
  if (age < 2 && cm > 92) return "อายุกับส่วนสูงไม่สมกัน (ไม่ถึง 2 ขวบ แต่สูงเกิน 92 ซม.)";
  if (age < 3 && cm > 105) return "อายุกับส่วนสูงไม่สมกัน (ไม่ถึง 3 ขวบ แต่สูงเกิน 105 ซม.)";
  return null;
}
