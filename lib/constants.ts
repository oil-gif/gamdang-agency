...
export const STATUS_LABEL_TH: Record<string, string> = {
  ...
  rejected: "ปฏิเสธ",
  inactive: "ไม่ใช้งาน",
  // ใบร่างจาก "เพิ่มด่วนจากคอมการ์ด" — ข้อมูลยังไม่ครบ ไม่ขึ้นหน้าเว็บ Public
  draft: "⚡ ใบร่าง",
};
...
// แถบตัวเลข (Talents / Models / Influencers / AI Models) บนหัวหน้า /talents
//
// ปิดไว้ก่อนตามที่พี่เจ้าของสั่ง 2026-08-11 — ยังย้ายฐานข้อมูลจากระบบเดิมไม่เสร็จ
// ตัวเลขเลยยังน้อยกว่าที่มีจริง โชว์ไปลูกค้าจะดูเอเจนซี่เล็กกว่าความเป็นจริง
// **เปิดกลับเมื่อไหร่ก็แก้บรรทัดนี้เป็น true อย่างเดียว** (โค้ดยังอยู่ครบ)
// ตอนปิดอยู่ระบบจะไม่ยิง query นับด้วย — ไม่เปลืองรอบฐานข้อมูลฟรีๆ
export const SHOW_TALENT_STATS: boolean = false;
...
export const BOOKING = {
  ...
  photoCap: 16, // ห้องถ่ายภาพ ต่อชั่วโมง
  videoCap: 14, // ห้องวิดีโอ ต่อชั่วโมง
  packages: {
    A: {
      name: "Package A",
