...
**migration 025 ⏳ ยังไม่ได้รัน** · `supabase/migrations/025_booking_postponed.sql`
...
ทดสอบ: ตรรกะจับคู่ 10 เคส ผ่านหมด (เบอร์มีขีด/เว้นวรรค/+66 → จับคู่ได้ ·
คนละเบอร์/จองก่อนหน้า/ไม่มีเบอร์+ไม่มี LINE/เบอร์สั้นผิดปกติ → ไม่จับมั่ว ·
มีหลายใบ → เอาใบล่าสุด) · ทุกรอบถ่าย ทุกแท็บเปิดได้ปกติ
